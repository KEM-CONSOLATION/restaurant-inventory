-- =====================================================
-- RESET ALL SALES AND STOCK DATA FOR ORGANIZATION AND BRANCH
-- WARNING: This will DELETE all sales, stock, and related data!
...
BEGIN
  RAISE NOTICE '========================================';
  RAISE NOTICE 'RESETTING ALL DATA FOR ORGANIZATION AND BRANCH';
  ...
  -- Reset item quantities to zero (optional - uncomment if you want to reset item quantities too)
  -- UPDATE items
  -- SET quantity = 0
  -- WHERE organization_id = v_org_id
  --   AND (branch_id = v_branch_id OR branch_id IS NULL);
  -- RAISE NOTICE 'Reset item quantities to zero';
