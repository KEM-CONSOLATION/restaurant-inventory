      ...
      <div>
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">
            Automatically calculated and created from previous day's closing stock. Manual entry
            available for past dates.
          </p>
          <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-lg">
            <p className="text-sm text-green-800">
              <strong>✓ Automatic:</strong> Opening stock is automatically created from yesterday's
              closing stock. No manual action required for today.
            </p>
            <p className="text-sm text-blue-800 mt-2">
              <strong>📝 Past Dates:</strong> Select a past date to manually enter opening stock
